...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15/04/2026 às 17:48
...
(1, 'Pokopia', 'A colorful adventure game with exploration and puzzles.', '2026-03-05', 'Indie Studio', 'Indie Studio', 'images/nintendoGames/pokopia.png', '2026-03-23 07:56:56', 366893),
...
INSERT INTO `users` (`user_id`, `username`, `email`, `password_hash`, `profile_picture`, `bio`, `favorite_genre`, `created_at`, `role`) VALUES
(1, 'testuser', 'test@example.com', '123', NULL, 'This is a test user', NULL, '2026-03-21 02:54:58', 'user'),
(4, 'testuser5', 'test1@test.com', '$2y$10$54H/ghAhfjjYIvq8cgqC4OS3UWCbuxtEWXrfpVueX0A5Nhu0WGUyK', '1774248968_126472.png', 'Test 5', 'Strategy', '2026-03-21 06:32:51', 'user'),
(5, 'medalofmine', 'medal@gmail.com', '$2y$10$/OobkFHOfTy5e5TxFdlKGeu0GGGibEAzE90InxHbTMxyQyHzb.mWi', NULL, 'afonso', 'Simulation', '2026-03-21 06:37:51', 'admin'),
(7, 'test3', 'test2@gmail.com', '$2y$10$bxWVGMjnZ1O7RjDFwpBJCOrCW.k/K7uVDv4GsnDq7F.ITcHmNCWkS', NULL, NULL, NULL, '2026-04-15 01:45:19', 'user');
